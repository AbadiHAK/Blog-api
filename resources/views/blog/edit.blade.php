...
@endif
<form action="{{ URL::to('update-blog') }}/{{$blog->id}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
      <label for="exampleInputEmail1">Enter Blog title</label>
      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Blog title" name="blogTitle" value="{{ $blog->title }}">
    </div>
    <div class="form-group">
